...
export const makeClass = (feilds: VarDecl[], methods: Binding[]): Class =>
    ({tag: "Class", feilds: feilds, methods: methods, env: makeEmptyEnv() });
export const makeObject = (val: Class): Object =>
    ({tag: "Object", val: val, env: makeEmptyEnv()})
export const makeObjectEnv = (val: Class, env: Env): Object =>
    ({tag: "Object", val: val, env: env});
